---
title: "Coronavirus in United Kingdom"
...
### **Daily cumulative cases by type** (United Kingdom only)
...
**The Coronavirus Dashboard: the case of United Kingdom**

This Coronavirus dashboard: the case of United Kingdom provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for United Kingdom. This dashboard is built with R using the R Makrdown framework and was initially adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin and then by this [dashboard](https://www.antoinesoetewey.com/files/coronavirus-dashboard.html){target="_blank"} by Antoine Soetewey.
