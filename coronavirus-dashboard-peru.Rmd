...
### **Daily cumulative cases by type** (Peru only)
...
**The Coronavirus Dashboard: the case of Peru**

This Coronavirus dashboard: the case of Peru provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Peru. This dashboard is built with R using the R Makrdown framework and was adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin and this [dashboard](https://www.antoinesoetewey.com/files/coronavirus-dashboard.html) by Antoine Soetewey.
