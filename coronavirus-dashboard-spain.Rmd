...
This Coronavirus dashboard: the case of Spain provides an overview of the 2019 Novel Coronavirus COVID-19 (2019-nCoV) epidemic for Spain. This dashboard is built with R using the R Makrdown framework and was adapted from this [dashboard](https://ramikrispin.github.io/coronavirus_dashboard/){target="_blank"} by Rami Krispin and then from this [dashboard](https://www.antoinesoetewey.com/files/coronavirus-dashboard.html) by Antoine Soetewey.
